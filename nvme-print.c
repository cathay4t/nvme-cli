		       ...
		       void (*vs)(__u8 *vs, struct json_object *root))
{
	...
	json_object_add_value_int(root, "ver", nvme_ctrl_ver_get(ctrl));
	json_object_add_value_string(root, "ver_str",
				     nvme_ctrl_ver_str_get(ctrl));
	json_object_add_value_int(root, "rtd3r", nvme_ctrl_rtd3r_get(ctrl));
	json_object_add_value_int(root, "rtd3e", nvme_ctrl_rtd3e_get(ctrl));
	json_object_add_value_int(root, "oaes", nvme_ctrl_oaes_get(ctrl));
	...
	json_object_add_value_int(root, "hmpre", nvme_ctrl_hmpre_get(ctrl));
	json_object_add_value_int(root, "hmmin", nvme_ctrl_hmmin_get(ctrl));
	...
	json_object_add_value_int(root, "nn", nvme_ctrl_nn_get(ctrl));
